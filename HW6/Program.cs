...
namespace   MyApp // Note: actual namespace depends on the project name.
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Zgony.use_LINQ_with_CSV_zgony(
                 @"d:\work\2022\proj_cs\HW6\dat\ewp_dsh_zgony_po_szczep_20220127.csv",
                 @"d:\work\2022\proj_cs\HW6\grouped_by_producent_zgony_po_szczep_20220127.csv"
            );

            Zakazenia.use_LINQ_with_CSV_zakazenia(
                @"d:\work\2022\proj_cs\HW6\dat\ewp_dsh_zgony_po_szczep_202202010941.csv",
                @"d:\work\2022\proj_cs\HW6\grouped_by_producent_zgony_po_szczep_202202010941.csv"
            );
    ...
    public static decimal SumDecimal(string val)
    {
        ...
        static void use_LINQ_with_CSV_zgony( string inFileName, string outFileName )
        {        
